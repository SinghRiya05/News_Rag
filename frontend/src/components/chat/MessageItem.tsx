      ...
      {(message.aiResponse || message.status === 'loading') && (
        <div className="flex justify-start gap-4">
          ...
          <div className="max-w-[85%] flex flex-col gap-4">
            <div className="bg-surface-container p-6 rounded-2xl rounded-tl-none shadow-sm dark:bg-gray-800 border border-outline-variant/30 relative group/msg">
              {!message.aiResponse ? (
                ...
                <>
                  ...
                  <div className="mt-4 pt-4 border-t border-outline-variant/30 flex justify-end">
                    <button 
                      ...
                      className="flex items-center gap-2 text-xs font-bold text-primary hover:bg-primary-container px-3 py-1.5 rounded-lg transition-all active:scale-95"
                    >
                      <BarChart3 size={14} />
                      Analyze with AI
                    </button>
            ...
            {message.sources && message.sources.length > 0 && (
              <div className="mt-4">
                <h4 className="text-[11px] font-bold text-on-surface-variant uppercase mb-3 px-1 tracking-widest opacity-60">
                  Sources Used
                </h4>
